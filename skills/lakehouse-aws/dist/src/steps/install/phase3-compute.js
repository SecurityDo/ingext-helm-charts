...
export async function runPhase3Compute(env, options) {
    ...
    if (!readyCheck.ready) {
        ...
        const podsResult = await getPodsInNamespace("kube-system", "app.kubernetes.io/name=karpenter", profile, region);
